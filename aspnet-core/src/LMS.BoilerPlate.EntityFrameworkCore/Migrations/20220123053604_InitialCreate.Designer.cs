...
namespace LMS.BoilerPlate.Migrations
{
    ...
    [Migration("20220123053604_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Abp.Webhooks.WebhookSendAttempt", b =>
                {
                    ...
                    b.Property<byte[]>("WebhookEventId")
                        .IsRequired()
                        .HasColumnType("varbinary(16)");

                    b.Property<byte[]>("WebhookSubscriptionId")
                        .IsRequired()
                        .HasColumnType("varbinary(16)");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("LMS.BoilerPlate.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("LMS.BoilerPlate.Authorization.Users.User", null)
                        .WithMany("Claims")
