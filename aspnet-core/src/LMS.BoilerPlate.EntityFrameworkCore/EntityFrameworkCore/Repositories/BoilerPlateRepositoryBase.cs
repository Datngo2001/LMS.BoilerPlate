...
namespace LMS.BoilerPlate.EntityFrameworkCore.Repositories
{
    /// <summary>
    ...
    /// </summary>
    /// <typeparam name="TEntity">Entity type</typeparam>
    public abstract class BoilerPlateRepositoryBase<TEntity> : BoilerPlateRepositoryBase<TEntity, int>, IRepository<TEntity>
