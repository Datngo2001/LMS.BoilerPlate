...
using LMS.BoilerPlate.EntityFrameworkCore.Seed.Host;
using LMS.BoilerPlate.EntityFrameworkCore.Seed.Tenants;
using LMS.BoilerPlate.MultiTenancy;

namespace LMS.BoilerPlate.Tests
{
    public abstract class BoilerPlateTestBase : AbpIntegratedTestBase<BoilerPlateTestModule>
    {
